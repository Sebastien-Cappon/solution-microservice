package com.mediLaboSolutions.T2D2Authentication.config;
...
public class ActuatorConfig {
	...
	/**
	 * The Bean required to run <code>httpExchanges</code>. I'll not write it this
	 * time ^^. You know what I'm talking about, because YOU READ ALL THE JAVADOC
	 * !!!
	 * 
