package com.mediLaboSolutions.T2D2Note.integration;
...
import com.mediLaboSolutions.T2D2Note.util.ModelInstanceBuilder;
...
public class NoteServiceIT {
	...
	private MongoDatabase testMongoDatabase = testMongoClient.getDatabase("mls_t2d2_note_test");
